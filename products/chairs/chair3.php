    ...
    <div id="container">
        ...
        <div id="content">
            ...
            <div id="name">
                ...
                <p>Fotel biurowy Shine biały</p><!---->

            </div>

            <div id="product">

                <img src="../../img/changing/chairs/chair3.jpg" alt=""><!---->
            ...
            <div id="info">
                ...
                <div id="action">
                    ...
                    <span>1 966 PLN</span> 
                    <a href="chair3.php?name=true" id="adding" >Dodaj do koszyka</a>
                </div><!---->
                ...
                <div id="bonus">
                    ...
                    <img src="https://pim.elzap.eu/resource/wymiary-shine-120.png?w=700&amp" alt="wymiary"><!---->
                </div>
            </div>
